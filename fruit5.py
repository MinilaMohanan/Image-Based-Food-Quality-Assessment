...
model = tf.keras.models.load_model("C:/Users/SYS/OneDrive/Desktop/minila/base_data/models/fruit_model .h5")
model_class_names = ['Fresh Apple', 'Rotten Apple']  # Define the class names
